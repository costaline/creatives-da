...
function cleanghub() {
  return del([
    "/home/constantine/Документы/GitHub/costaline.github.io/projects/creative-digital-agencies/*"
  ], { force: true });
}

function copyghub() {
  return gulp.src("build/**")
    .pipe(gulp.dest("/home/constantine/Документы/GitHub/costaline.github.io/projects/creative-digital-agencies"));
}
